(function () {
    ...
    function getDB() {
        // Supabase REST API via SupabaseClient
    ...
    async function ensureSessionFromStorage() {
        ...
        // Session is persisted in localStorage, check if it's there
                ...
                ${user ? `
                    <div class="sidebar__user" id="sidebarUserRow" role="button" tabindex="0" title="Ver perfil" style="cursor:pointer">
                        ...
                        <div class="sidebar__user-info">
                            <span class="sidebar__user-name">${userName}${isAdmin ? ' <span class="admin-badge">Admin</span>' : ''}</span>
    ...
    function renderBottomNav() {
        ...
        const bottomItems = [
            ...
            { key: 'sentimientos', label: 'Sentimientos', icon: 'heart-handshake', href: '/pages/sentimientos.html' },
            { key: 'puffy', label: 'OsitosWorld', icon: 'paw-print', href: '/pages/ositos-world.html' },
            ...(isAdmin ? [{ key: 'admin', label: 'Admin', icon: 'settings', href: '/pages/admin.html' }] : []),
