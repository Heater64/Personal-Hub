...
export const GAMES = [
  ...
  // ── Rediseñados · cada juego con su modo online ──
  { id: 'asteroides', icon: 'asteroid', title: 'Asteroides',    desc: 'Destruye las rocas y sobrevive al espacio. Reflejos y puntería.',            href: '/games/asteroides.html', color: '#e8735a', accent: '#f7a180', difficulty: 'Difícil', category: 'Acción',     duration: '1-4 min' },
  { id: 'dino',       icon: 'dino',     title: 'Dino Run',      desc: 'Corre sin parar, salta obstáculos y llega lo más lejos posible.',           href: '/games/dino.html',       color: '#5ad68f', accent: '#8ae8b3', difficulty: 'Fácil',   category: 'Arcade',     duration: '1-5 min' },
  { id: 'doodle',     icon: 'doodle',   title: 'Doodle Jump',   desc: 'Salta de plataforma en plataforma sin caerte. Cada vez más alto.',          href: '/games/doodle.html',     color: '#7c9cff', accent: '#a5baff', difficulty: 'Medio',   category: 'Arcade',     duration: '1-5 min' },
  { id: 'flappy',     icon: 'flappy',   title: 'Flappy',        desc: 'Guía al pajarito entre los tubos. Un toque de precisión.',                  href: '/games/flappy.html',     color: '#ffcf4d', accent: '#ffe59a', difficulty: 'Difícil', category: 'Arcade',     duration: '1-3 min' },
  { id: 'match3',     icon: 'diamond',  title: 'Match-3',       desc: 'Intercambia gemas y haz líneas de tres. Las cadenas suman puntos.',        href: '/games/match3.html',     color: '#4ade80', accent: '#8ae8b3', difficulty: 'Medio',   category: 'Puzzle',     duration: '3-10 min' },
  { id: 'nonogramas', icon: 'pixels',   title: 'Nonogramas',    desc: 'Rellena la cuadrícula siguiendo las pistas y descubre el dibujo.',        href: '/games/nonogramas.html', color: '#4ade80', accent: '#8ae8b3', difficulty: 'Medio',   category: 'Puzzle',     duration: '5-15 min' }
];
...
const ICONS = {
  ...
  'dino': '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 21V7l7-4 7 4v14"/><path d="M9 21v-4h6v4"/><path d="M5 11h14"/><circle cx="16" cy="8" r="1" fill="currentColor"/><path d="M12 3v8"/></svg>',
  'doodle': '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 3a3 3 0 0 1 3 3v6a3 3 0 0 1-6 0V6a3 3 0 0 1 3-3z"/><path d="M7 21h10"/><path d="M12 15v6"/></svg>',
  'flappy': '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 20c6-2 10-6 12-11"/><path d="M15 9c-1 2-2 3-4 4 3 1 5 3 6 6 1-3 3-4 4-4-3-1-5-3-6-6z"/><circle cx="17" cy="5" r="2"/></svg>',
  'diamond': '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M6 3h12l4 6-10 12L2 9z"/><path d="M2 9h20"/><path d="M12 21 8 9l4-6 4 6-4 12"/></svg>',
  'pixels': '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><rect x="7" y="7" width="3" height="3" rx="0.5" fill="currentColor"/><rect x="12" y="7" width="3" height="3" rx="0.5" fill="currentColor"/><rect x="7" y="12" width="3" height="3" rx="0.5" fill="currentColor"/><rect x="17" y="12" width="3" height="3" rx="0.5" fill="currentColor"/></svg>',
