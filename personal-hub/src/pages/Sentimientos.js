...
const ICON_SVGS = {
  'sparkles': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 3a9 9 0 0 0 9 9 9 9 0 0 0-9 9 9 9 0 0 0-9-9 9 9 0 0 0 9-9Z"/><path d="M8 8a5 5 0 0 0 5 5 5 5 0 0 0-5 5 5 5 0 0 0-5-5 5 5 0 0 0 5-5Z"/></svg>',
...
export function SentimientosPage(router) {
  ...
  page.innerHTML = `
    ...
    <div class="sentimientos-grid">
      ${CARDS.map(card => `
        <button type="button" class="sentimientos-card glass-card" data-href="${card.href}">
